...
// because Collection works for imutable collections of things,
...
// an uses it's Identifiable-ness to subscript into the Collection.
...
// if Set is used to represent the selection of emoji in assignment 5
// then this syntatic sugar function might be of use
...
// to help us with managing our Strings or emojis
